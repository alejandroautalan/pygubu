...
class TTKWidgetBO(BuilderObject):
    ...
    OPTIONS_WIDGET_SPECIFIC = tuple()
    OPTIONS_CUSTOM = tuple()
    ro_properties = ('class_',)


class TTKFrame(TTKWidgetBO):
    OPTIONS_WIDGET_SPECIFIC = ('borderwidth', 'relief', 'padding',
                               'height', 'width')
    class_ = ttk.Frame
    container = True
    properties = TTKWidgetBO.OPTIONS_STANDARD + OPTIONS_WIDGET_SPECIFIC

register_widget('ttk.Frame', TTKFrame, 'Frame', ('Containers', 'ttk'))


class TTKLabel(TTKWidgetBO):
    OPTIONS_STANDARD = TTKWidgetBO.OPTIONS_STANDARD + TTKWidgetBO.OPTIONS_LABEL
    OPTIONS_WIDGET_SPECIFIC = ('anchor', 'background', 'borderwidth',
                               'font', 'foreground', 'justify', 'padding',
                               'relief', 'wraplength')
    class_ = ttk.Label
    container = False
    properties = OPTIONS_STANDARD + OPTIONS_WIDGET_SPECIFIC
...
class TTKButton(TTKWidgetBO):
    ...
    OPTIONS_WIDGET_SPECIFIC = ('command', 'default')
    class_ = ttk.Button
    container = False
    properties = OPTIONS_STANDARD + OPTIONS_WIDGET_SPECIFIC
...
class TTKCheckbutton(TTKWidgetBO):
    OPTIONS_STANDARD = (TTKWidgetBO.OPTIONS_STANDARD +
                        TTKWidgetBO.OPTIONS_LABEL +
                        TTKWidgetBO.OPTIONS_COMPATIBILITY)
    OPTIONS_WIDGET_SPECIFIC = ('command', 'offvalue', 'onvalue', 'variable')
...
class TTKRadiobutton(TTKWidgetBO):
    OPTIONS_STANDARD = (TTKWidgetBO.OPTIONS_STANDARD +
                        TTKWidgetBO.OPTIONS_LABEL +
                        TTKWidgetBO.OPTIONS_COMPATIBILITY)
    OPTIONS_WIDGET_SPECIFIC = ('command', 'value', 'variable')
...
class TTKCombobox(TTKWidgetBO):
    OPTIONS_WIDGET_SPECIFIC = ('exportselection', 'justify', 'height',
                               'postcommand', 'textvariable', 'values',
...
class TTKScrollbar(TTKWidgetBO):
    OPTIONS_WIDGET_SPECIFIC = ('command', 'orient')
...
class TTKSizegrip(TTKWidgetBO):
    ...
    properties = (TTKWidgetBO.OPTIONS_STANDARD +
                  TTKWidgetBO.OPTIONS_WIDGET_SPECIFIC)
...
class TTKEntry(TTKWidgetBO, EntryBaseBO):
    ...
    OPTIONS_WIDGET_SPECIFIC = ('exportselection', 'font', 'invalidcommand',
...
class TTKProgressbar(TTKWidgetBO):
    OPTIONS_WIDGET_SPECIFIC = ('orient', 'length', 'mode', 'maximum',
...
class TTKScale(TTKWidgetBO):
    OPTIONS_WIDGET_SPECIFIC = ('command', 'from_', 'length', 'orient',
                               'to', 'value', 'variable')
    class_ = ttk.Scale
    container = False
    properties = TTKWidgetBO.OPTIONS_STANDARD + OPTIONS_WIDGET_SPECIFIC
...
class TTKSeparator(TTKWidgetBO):
    OPTIONS_WIDGET_SPECIFIC = ('orient',)
...
class TTKLabelframe(TTKWidgetBO):
    ...
    OPTIONS_WIDGET_SPECIFIC = (TTKFrame.OPTIONS_WIDGET_SPECIFIC +
...
class TTKPanedwindow(TTKWidgetBO, PanedWindowBO):
    OPTIONS_WIDGET_SPECIFIC = ('orient', 'height', 'width')
...
class TTKNotebook(TTKWidgetBO):
    OPTIONS_WIDGET_SPECIFIC = ('height', 'padding', 'width')
    class_ = ttk.Notebook
    container = True
...
class TTKMenubuttonBO(TTKWidgetBO):
    OPTIONS_STANDARD = (TTKWidgetBO.OPTIONS_STANDARD +
                        TTKWidgetBO.OPTIONS_LABEL +
                        TTKWidgetBO.OPTIONS_COMPATIBILITY)
    OPTIONS_WIDGET_SPECIFIC = ('direction',)  # 'menu'
...
class TTKTreeviewBO(TTKWidgetBO):
    ...
    OPTIONS_WIDGET_SPECIFIC = ('height', 'padding', 'selectmode', 'show')
    class_ = ttk.Treeview
    container = False
...
class TTKPanedwindowPane(TTKWidgetBO, PanedWindowPaneBO):
    ...
    OPTIONS_WIDGET_SPECIFIC = ('weight',)
    class_ = None
    container = True
...
class TTKNotebookTab(TTKWidgetBO):
    OPTIONS_STANDARD = tuple()
    OPTIONS_WIDGET_SPECIFIC = ('state', 'sticky', 'padding', 'text',
...
class TTKTreeviewColBO(TTKWidgetBO):
    OPTIONS_STANDARD = tuple()
    OPTIONS_WIDGET_SPECIFIC = ('text', 'image', 'command', 'heading_anchor',
...
class TTKSpinboxBO(TTKWidgetBO, EntryBaseBO):
    ...
    OPTIONS_WIDGET_SPECIFIC = (TTKEntry.OPTIONS_WIDGET_SPECIFIC +
